...
use command::Command;
use embedded_graphics_core::prelude::{Dimensions, OriginDimensions, Point, Size};
...
impl Default for DataMapping {
    /// Creates a data mapping for the default orientation.
    ///
    ...
    SPI: SpiDevice<Error = SpiE>,
{
    ...
    /// [DataMapping::ccw90], the logical size is (64, 96) and the (0, 0) is
